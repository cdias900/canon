...
namespace SheepGate.UI
{
    ...
    ///   "unlock now". A locked row used to carry a talent price under its unlock sentence, staged
    ///   for a cosmetics shop that never landed; the talents went with the streak that paid them
    ///   (see <c>DailyCheckIn</c>), and the row is back to being an invitation with one route in.
    ///
    /// ==================================================================================
    /// WHAT THE TWO CALLERS DO DIFFERENTLY, AND WHY
    /// ==================================================================================
    /// One flag, and it is the difference between a wardrobe you are living in and a wardrobe you
